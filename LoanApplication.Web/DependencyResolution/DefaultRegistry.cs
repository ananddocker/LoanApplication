...
namespace LoanApplication.Web.DependencyResolution {
        ...
        public DefaultRegistry() {
            Scan(
                scan => {
                    ...
                    scan.AssemblyContainingType<LoanApplicationDbContext>();
            ...
            For<DbContext>().Use(ctx => new LoanApplicationDbContext());
